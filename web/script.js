...
source.onmessage = function (e) {
    ...
    if(response.DOTS===null){
        if((response.PLAYERS[0][1]>response.PLAYERS[1][1])&&(response.PLAYERS[0][1]>response.PLAYERS[2][1])&&(response.PLAYERS[0][1]>response.PLAYERS[3][1]))
            window.alert("Congratulations!Yellow player won the Game.Marks: "+response.PLAYERS[0][1]);
            ...
            window.alert("Congratulations!Orange player won the Game.Marks: "+response.PLAYERS[1][1]);
            ...
            window.alert("Congratulations!Cyan player won the Game.Marks: "+response.PLAYERS[2][1]);
            ...
            window.alert("Congratulations!Pink player won the Game.Marks: "+response.PLAYERS[3][1]);
        else
